# file to do heavy math (credit score check, interest rate adjustments)
...
def calculate_credit_score(customer):
    ...
    # pulls every loan linked to this specific customer
...
# logic to decide eligibility and rate correction
def get_eligibility_status(customer, loan_amount, interest_rate, tenure):
    ...
    if ((total_current_emis + new_emi) > (customer.monthly_salary * 0.5)):
        approved = False
